...
This website is probably the best source of information about _Featherlight_ but you can also check out the Tumblr blog ([{{< fa brands tumblr >}}  tumblr.com/featherlight-ttrpg](https://www.tumblr.com/featherlight-ttrpg)) for more updates.

**I'll also be starting a Kickstarter soon** to gather funds for commissioning an artist to illustrate [the homebrew settings](https://njlyon0.github.io/featherlight-ttrpg/settings.html) I'm working on **so stay tuned** for that!
